...
CREATE TABLE IF NOT EXISTS MUNICIPIO (
  CO_MUNICIPIO VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS ALUNO (
  ...
  CO_UF_NASCIMENTO VARCHAR(5),
  CO_MUNICIPIO_NASCIMENTO VARCHAR(15),
...
CREATE TABLE IF NOT EXISTS CURSO (
  CO_IES INT NOT NULL,
  CO_MUNICIPIO_CURSO VARCHAR(15),
  CO_UF_CURSO VARCHAR(5),
  NO_REGIAO_CURSO VARCHAR(45),
  IN_CAPITAL_CURSO VARCHAR(2),
  CO_CURSO INT NOT NULL,
  NO_CURSO VARCHAR(200),
  CO_SITUACAO_CURSO VARCHAR(15),
  DS_SITUACAO_CURSO VARCHAR(45),
  CO_OCDE VARCHAR(20),
  NO_OCDE VARCHAR(100),
  CO_OCDE_AREA_GERAL VARCHAR(20),
  NO_OCDE_AREA_GERAL VARCHAR(45),
  CO_OCDE_AREA_ESPECIFICA VARCHAR(20),
  NO_OCDE_AREA_ESPECIFICA VARCHAR(100),
  CO_OCDE_AREA_DETALHADA VARCHAR(20),
  NO_OCDE_AREA_DETALHADA VARCHAR(100),
  CO_GRAU_ACADEMICO VARCHAR(15),
  DS_GRAU_ACADEMICO VARCHAR(45),
  CO_MODALAIDADE_ENSINO VARCHAR(15),
  DS_MODALIDADE_ENSINO VARCHAR(45),
  CO_NIVEL_ACADEMICO VARCHAR(15),
  DS_NIVEL_ACADEMICO VARCHAR(45),
  IN_GRATUITO VARCHAR(2),
  TP_ATRIBUTO_INGRESSO INT,
  NU_CARGA_HORARIA INT,
  DT_INICIO_FUNCIONAMENTO VARCHAR(15),
  DT_AUTORIZACAO_CURSO VARCHAR(15),
  IN_AJUDA_DEFICIENTE VARCHAR(2),
  IN_MATERIAL_DIGITAL VARCHAR(2),
  IN_MATERIAL_AMPLIADO VARCHAR(2),
  IN_MATERIAL_TATIL VARCHAR(2),
  IN_MATERIAL_IMPRESSO VARCHAR(2),
  IN_MATERIAL_AUDIO VARCHAR(2),
  IN_MATERIAL_BRAILLE VARCHAR(2),
  IN_MATERIAL_LIBRAS VARCHAR(2),
  IN_DISCIPLINA_LIBRAS VARCHAR(2),
  IN_TRADUTOR_LIBRAS VARCHAR(2),
  IN_GUIA_INTERPRETE VARCHAR(2),
  IN_RECURSOS_COMUNICACAO VARCHAR(2),
  IN_RECURSOS_INFORMATICA VARCHAR(2),
  IN_INTEGRAL_CURSO VARCHAR(2),
  IN_MATUTINO_CURSO VARCHAR(2),
  IN_VESPERTINO_CURSO VARCHAR(2),
  IN_NOTURNO_CURSO VARCHAR(2),
  ...
  IN_OFERECE_DISC_SEMI_PRES VARCHAR(2),
  NU_PERC_CAR_HOR_SEMI_PRES VARCHAR(10),
  IN_POSSUI_LABORATORIO VARCHAR(2),
...
CREATE TABLE IF NOT EXISTS LOCAL_OFERTA (
  ...
  NO_LOCAL_OFERTA VARCHAR(150),
  IES_CO_IES INT NOT NULL,
  CO_UF_LOCAL_OFERTA VARCHAR(5),
  CO_MUNICIPIO_LOCAL_OFERTA VARCHAR(15),
  IN_SEDE VARCHAR(2),
...
CREATE TABLE IF NOT EXISTS CURSO_ALUNO (
  CO_CURSO INT NOT NULL,
  NO_CURSO VARCHAR(300) NOT NULL,
  CO_TURNO_ALUNO VARCHAR(5),
  CO_ALUNO_CURSO INT,
  CO_ALUNO_CURSO_ORIGEM VARCHAR(10),
  CO_ALUNO BIGINT NOT NULL,
  CO_ALUNO_SITUACAO INT NOT NULL,
  QT_CARGA_HORARIA_TOTAL INT,
  QT_CARGA_HORARIA_INTEG INT,
  DT_INGRESSO_CURSO VARCHAR(15),
  IN_ING_VESTIBULAR VARCHAR(2),
  IN_ING_ENEM VARCHAR(2),
  IN_ING_AVALIACAO_SERIADA VARCHAR(2),
  IN_ING_SELECAO_SIMPLIFICADA VARCHAR(2),
  IN_ING_SELECAO_VAGA_REMANESC VARCHAR(2),
  IN_ING_SELECAO_VAGA_PROG_ESPEC VARCHAR(2),
  IN_ING_TRANSF_EXOFFICIO VARCHAR(2),
  IN_ING_DECISAO_JUDICIAL VARCHAR(2),
  IN_ING_CONVENIO_PECG VARCHAR(2),
  IN_RESERVA_VAGAS VARCHAR(2),
  IN_RESERVA_ETNICO VARCHAR(2),
  IN_RESERVA_DEFICIENCIA VARCHAR(2),
  IN_RESERVA_ENSINO_PUBLICO VARCHAR(2),
  IN_RESERVA_RENDA_FAMILIAR VARCHAR(2),
  IN_RESERVA_OUTRA VARCHAR(2),
  IN_FINANC_ESTUDANTIL VARCHAR(2),
  IN_FIN_REEMB_FIES VARCHAR(2),
  IN_FIN_REEMB_ESTADUAL VARCHAR(2),
  IN_FIN_REEMB_MUNICIPAL VARCHAR(2),
  IN_FIN_REEMB_PROG_IES VARCHAR(2),
  IN_FIN_REEMB_ENT_EXTERNA VARCHAR(2),
  IN_FIN_REEMB_OUTRA VARCHAR(2),
  IN_FIN_NAOREEMB_PROUNI_INTEGR VARCHAR(2),
  IN_FIN_NAOREEMB_PROUNI_PARCIAL VARCHAR(2),
  IN_FIN_NAOREEMB_ESTADUAL VARCHAR(2),
  IN_FIN_NAOREEMB_MUNICIPAL VARCHAR(2),
  IN_FIN_NAOREEMB_PROG_IES VARCHAR(2),
  IN_FIN_NAOREEMB_ENT_EXTERNA VARCHAR(2),
  IN_FIN_NAOREEMB_OUTRA VARCHAR(2),
  IN_APOIO_SOCIAL VARCHAR(2),
  IN_APOIO_ALIMENTACAO VARCHAR(2),
  IN_APOIO_BOLSA_PERMANENCIA VARCHAR(2),
  IN_APOIO_BOLSA_TRABALHO VARCHAR(2),
  IN_APOIO_MATERIAL_DIDATICO VARCHAR(2),
  IN_APOIO_MORADIA VARCHAR(2),
  IN_APOIO_TRANSPORTE VARCHAR(2),
  IN_ATIVIDADE_EXTRACURRICULAR INT,
  IN_COMPL_ESTAGIO VARCHAR(2),
  IN_COMPL_EXTENSAO VARCHAR(2),
  IN_COMPL_MONITORIA VARCHAR(2),
  IN_COMPL_PESQUISA VARCHAR(2),
  IN_BOLSA_ESTAGIO VARCHAR(2),
  IN_BOLSA_EXTENSAO VARCHAR(2),
  IN_BOLSA_MONITORIA VARCHAR(2),
  IN_BOLSA_PESQUISA VARCHAR(2),
  CO_TIPO_ESCOLA_ENS_MEDIO INT,
  IN_ALUNO_PARFOR VARCHAR(2),
  CO_SEMESTRE_CONCLUSAO VARCHAR(20),
  CO_SEMESTRE_REFERENCIA INT,
  IN_MOBILIDADE_ACADEMICA VARCHAR(2),
  CO_MOBILIDADE_ACADEMICA VARCHAR(20),
  CO_MOBILIDADE_ACADEMICA_INTERN VARCHAR(20),
  CO_IES_DESTINO VARCHAR(20),
  CO_PAIS_DESTINO VARCHAR(20),
...
CREATE TABLE IF NOT EXISTS REGIME_TRABALHO (
  CO_REGIME_TRABALHO VARCHAR(10) NOT NULL,
...
LOAD DATA LOCAL INFILE 'MANTENEDORA.CSV'
INTO TABLE MANTENEDORA
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'CATEGORIA_ADMINISTRATIVA.CSV'
INTO TABLE CATEGORIA_ADMINISTRATIVA
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'ORGANIZACAO_ACADEMICA.CSV'
INTO TABLE ORGANIZACAO_ACADEMICA
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'UF.CSV'
INTO TABLE UF
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'MUNICIPIO.CSV'
INTO TABLE MUNICIPIO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'IES.CSV'
INTO TABLE IES
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'COR_RACA.CSV'
INTO TABLE COR_RACA
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'SEXO.CSV'
INTO TABLE SEXO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'SITUACAO_ALUNO.CSV'
INTO TABLE ALUNO_SITUACAO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'NACIONALIDADE.CSV'
INTO TABLE NACIONALIDADE
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'TURNO.CSV'
INTO TABLE TURNO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'ALUNO.CSV'
INTO TABLE ALUNO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'TECNICO.CSV'
INTO TABLE TECNICO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'VALORES.CSV'
INTO TABLE VALORES
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'LOCAL_OFERTA.CSV'
INTO TABLE LOCAL_OFERTA
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'CURSO.CSV'
INTO TABLE CURSO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'CURSO_ALUNO.CSV'
INTO TABLE CURSO_ALUNO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'SITUACAO_DOCENTE.CSV'
INTO TABLE SITUACAO_DOCENTE
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'ESCOLARIDADE_DOCENTE.CSV'
INTO TABLE ESCOLARIDADE_DOCENTE
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'REGIME_TRABALHO.CSV'
INTO TABLE REGIME_TRABALHO
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'DOCENTE.CSV'
INTO TABLE DOCENTE
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'IES_DOCENTE.CSV'
